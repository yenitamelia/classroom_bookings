...
if ($this->userauth->logged_in()) {
	$menu[1]['text'] = img('assets/images/ui/link_controlpanel.png', FALSE, 'hspace="4" align="top" alt=" "') . 'Dashboard';
			...
			<div class="nav-box">
				...
				if (isset($menu)) {
					foreach ($menu as $link) {
						...
						if ($i < count($menu) - 1) {
							echo img('assets/images/blank.png', FALSE, 'width="16" height="16"');
						}
						$i++;
					}
				}
